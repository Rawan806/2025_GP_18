...
import 'package:image_picker/image_picker.dart'; // ✅ إضافة بسيطة
              ...
              children: [
                TextFormField(
                  ...
                  decoration: _inputDeco(
                    AppLocalizations.translate('lostDateTime', currentLocale.languageCode),
                ...
                TextFormField(
                  ...
                  decoration: _inputDeco(
                    AppLocalizations.translate('lostItemName', currentLocale.languageCode),
                  ),
                  validator: (v) => (v == null || v.trim().isEmpty)
                ...
                DropdownButtonFormField<String>(
                  ...
                  decoration: _inputDeco(
                    AppLocalizations.translate('category', currentLocale.languageCode),
                  ),
                  items: categories
                  ...
                  validator: (v) => (v == null || v.isEmpty)
                      ? AppLocalizations.translate('pleaseSelectCategory', currentLocale.languageCode)
                      : null,
                ),
                const SizedBox(height: 15),
                ...
                if (_selectedCategory ==
                  ...
                  TextFormField(
                    ...
                    decoration: _inputDeco(
                      AppLocalizations.translate('otherCategory', currentLocale.languageCode),
                    ),
                    validator: (v) =>
                    (_selectedCategory ==
                        AppLocalizations.translate('other', currentLocale.languageCode) &&
                ...
                TextFormField(
                  ...
                  maxLines: 4,
                  decoration: _inputDeco(
                    AppLocalizations.translate('additionalDescription', currentLocale.languageCode),
                  ),
                ),
                  ...
                  onPressed: () {
                    ...
                    if (!valid) {
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(
                          content: Text(
                            AppLocalizations.translate('fillAllFields', currentLocale.languageCode),
                          ),
                        ),
                      );
                      return;
